...
UNIQUE_ID = f"{VERSION};QFW;{POSTSCRIPT_NAME};20260924"
MAC_EPOCH = datetime(1904, 1, 1, tzinfo=timezone.utc)
BUILD_TIMESTAMP = int((datetime(2026, 9, 24, tzinfo=timezone.utc) - MAC_EPOCH).total_seconds())
