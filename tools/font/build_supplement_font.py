...
- 奥 optical alignment（Version 1.019）：U+5965 `奥` 保留官方來源 drawing，以 U+5967 `奧` 為主要 reference，套用 uniform scale 0.895、dx +10.5、dy +34，再加 6-unit boundary embolden 補回縮放損失的筆重；advance 設為 790，derived outline 的 LSB／RSB 為 128／129，不修改其他 Han 或假名
