...
def main() -> int:
    ...
    try:
        ...
        if hira_centers and han_centers:
            ...
            require(abs(hira_center - JAPANESE_BOTTOM_ALIGNMENT_SHIFT - han_center) <= 30,
    ...
    print("PASS: final TTF advances, bounds, Version 1.031 metadata, and retained pre-translation optical-center stage are valid")
    return 0
