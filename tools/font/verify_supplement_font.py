...
VERSION = "1.018"
UNIQUE_ID = "1.018;QFW;QuanFangweiSupplementScript-Regular;20260826"
...
JAPANESE_SOURCE_CMAP_OVERRIDES = {
    0x3005, 0x4ED8, 0x512A, 0x54C0, 0x5967, 0x5BB9,
    0x5909, 0x5BC4, 0x604B, 0x61D0, 0x6C17,
}
...
def verify() -> list[str]:
    ...
    require(len(ttf_order) == len(source_order) + 206, "Derived glyph count did not increase by exactly 206")
...
def main() -> int:
    ...
    print("PASS: original cmap mappings are preserved except eleven documented Japanese overrides; original glyph order remains a prefix")
