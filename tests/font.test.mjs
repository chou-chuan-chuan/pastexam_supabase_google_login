...
test("loads the versioned supplemental webfont first and manifests French, German, and Japanese coverage", async () => {
  ...
  assert.equal(manifest.derived_font.version, "1.023");
  assert.match(css, /QuanFangweiSupplementScript-Regular\.woff2\?v=1\.023/);
  assert.match(css, /QuanFangweiSupplementScript-Regular\.ttf\?v=1\.023/);
