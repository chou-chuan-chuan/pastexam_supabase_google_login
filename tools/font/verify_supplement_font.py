...
def verify() -> list[str]:
    ...
    require(len(ttf_order) == len(source_order) + 205, "Derived glyph count did not increase by exactly 205")
...
def main() -> int:
    ...
    print("PASS: original cmap mappings are preserved except ten documented Japanese overrides; original glyph order remains a prefix")
